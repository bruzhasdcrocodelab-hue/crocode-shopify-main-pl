...
const Card = ({ className, text, background }: TPropsCard) => {
  return (
    <div className={`${styles.card} ${className}`}>
      {background && (
        <Background desktop={background.src} alt={background.alt} />
      )}
        ...
        <BlurIn>
          <div className={styles.section__list}>
            <Card
              ...
              background={{
                src: "/images/cards/why-crocode/whycrocode-card-1.png",
                alt: "card",
              }}
            />
            <Card
              className={styles.section__card}
              background={{
                src: "/images/cards/why-crocode/bg-image-1.webp",
                alt: "card",
              }}
            />
            <Card
              className={styles.section__card}
              background={{
                src: "/images/cards/why-crocode/bg-image-2.webp",
                alt: "card",
              }}
            />
            <Card
              ...
              background={{
                src: "/images/cards/why-crocode/whycrocode-card-2.png",
                alt: "card",
              }}
            />
            <Card
              ...
              background={{
                src: "/images/cards/why-crocode/whycrocode-card-3.png",
                alt: "card",
              }}
            />
            <Card
              ...
              background={{
                src: "/images/cards/why-crocode/whycrocode-card-4.png",
                alt: "card",
              }}
            />
          </div>
